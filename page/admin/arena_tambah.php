...
if (isset($_POST['submit'])) {
    ...
    $stmt = $conn->prepare("INSERT INTO arena (nama_arena, foto_arena, deskripsi_arena) VALUES (?, ?, ?)");
...
<div class="main-content-edit">
    ...
    <section>
        <div class="edtkuda-kontener">
            <h2>Tambah Arena Balap</h2>
            
            <form method="POST" enctype="multipart/form-data">
                <div class="kudaedt-grid">
                    <div class="kudaedt-kiri">
                        <label>Nama Arena:</label>
                        <input type="text" name="nama_arena" required>

                        <label>Deskripsi Arena:</label>
                        <textarea name="deskripsi_arena" rows="8" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px;"></textarea>
                    </div>
                    ...
                    <div class="kudaedt-kanan">
                        ...
                        <label>Upload Foto Arena:</label>
                        <input type="file" name="foto_arena" id="fotoInput" accept="image/*" required>
                    </div>
                </div>
